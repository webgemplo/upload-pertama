...
<html lang="en">
  <head>
    ...
    <title>PENDAFTARAN CALON SISWA DAN SISWI PKBM BINA HARAPAN </title>
    <!-- Bootstrap core CSS -->
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="http://pkbmbinaharapan.com/">PKBM BINA HARAPAN</a></li>
            <li><a href="http://pkbmbinaharapan.com/#divisi">DIVISI</a></li>
            <li><a href="http://pkbmbinaharapan.com/#sejarah">SEJARAH</a></li>
            <li><a href="http://pkbmbinaharapan.com/#kegiatan">KEGIATAN</a></li>
          </ul>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="http://pkbmbinaharapan.com/index.html">PKBM BINA HARAPAN</a></li>
